# -*- coding: utf-8 -*-
#
# wheezy.caching documentation build configuration file, created by
...
htmlhelp_basename = 'wheezy.cachingdoc'
...
latex_documents = [
  ('index', 'wheezy.caching.tex', u'wheezy.caching Documentation',
...
man_pages = [
    ('index', 'wheezy.caching', u'wheezy.caching Documentation',
